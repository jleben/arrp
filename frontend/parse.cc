// Generated by Bisonc++ V4.05.00 on Fri, 30 May 2014 15:11:51 -0700
...
PI__ const s_productionInfo[] = 
{
     ...
     {281, 1}, // 24: atom (ID) ->  ID
     {280, 7}, // 25: for_stmt (FOR) ->  FOR '(' for_spec_list ')' '{' for_body '}'
     {282, 3}, // 26: for_spec_list (';') ->  for_spec_list ';' for_spec
     {282, 2}, // 27: for_spec_list (';') ->  for_spec_list ';'
     {282, 1}, // 28: for_spec_list ->  for_spec
     {284, 2}, // 29: for_spec ->  for_iter_spec for_domain_spec
     {285, 2}, // 30: for_iter_spec (EACH) ->  EACH ID
     {285, 4}, // 31: for_iter_spec (INT) ->  INT ID for_iter_hop for_iter_offset
     {287, 0}, // 32: for_iter_hop ->  <empty>
     {287, 2}, // 33: for_iter_hop (EVERY) ->  EVERY INT
     {288, 0}, // 34: for_iter_offset ->  <empty>
     {288, 2}, // 35: for_iter_offset (AT) ->  AT INT
     {286, 0}, // 36: for_domain_spec ->  <empty>
     {286, 2}, // 37: for_domain_spec (IN) ->  IN for_domain_list
     {289, 1}, // 38: for_domain_list (ID) ->  ID
     {289, 3}, // 39: for_domain_list (ID) ->  ID ',' for_domain_list
     {283, 1}, // 40: for_body ->  expr
     {283, 1}, // 41: for_body ->  for_stmt
     {290, 1}, // 42: program_$ ->  program
};
...
{
    { { REQ_TOKEN}, {  6} },                 
    { {       282}, { 43} }, // for_spec_list
    { {       284}, { 44} }, // for_spec     
    { {       285}, { 45} }, // for_iter_spec
    { {       262}, { 46} }, // EACH         
    { {       258}, { 47} }, // INT          
    { {         0}, {  0} },                 
};
