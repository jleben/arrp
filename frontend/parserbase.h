...
// $insert polymorphicSpecializations
    ...
    template <>
    struct TagOf<ast::reduce_expression>
    {
        static Tag__ const tag = Tag__::REDUCE;
    };

    template <>
    struct TagOf<ast::for_iteration>
    {
        static Tag__ const tag = Tag__::FOR_ITER;
    };

    template <>
    struct TagOf<ast::for_expression>
    {
        static Tag__ const tag = Tag__::FOR;
    };

    template <>
    struct TagOf<ast::call>
    {
        static Tag__ const tag = Tag__::CALL;
    };

    template <>
    struct TagOf<sp<ast::expression>>
    {
        static Tag__ const tag = Tag__::EXPR;
    };

    template <>
    struct TagOf<ast::statement_list>
    {
        static Tag__ const tag = Tag__::STMT_LIST;
    };

    template <>
    struct TagOf<ast::id_list>
    {
        static Tag__ const tag = Tag__::ID_LIST;
    };

    template <>
    struct TagOf<ast::statement>
    {
        static Tag__ const tag = Tag__::STMT;
    };

    template <>
    struct TagOf<ast::expression_list>
    {
        static Tag__ const tag = Tag__::EXPR_LIST;
    };

    template <>
    struct TagOf<ast::node>
    {
    ...
    struct TagOf<double>
    {
        static Tag__ const tag = Tag__::REAL;
    };

    template <>
    struct TagOf<ast::for_iteration_list>
    {
        static Tag__ const tag = Tag__::FOR_ITER_LIST;
    };

    template <>
    struct TagOf<ast::expression_block>
    {
        static Tag__ const tag = Tag__::EXPR_BLOCK;
    };

    template <>
    struct TagOf<ast::hash_expression>
    {
        static Tag__ const tag = Tag__::HASH;
    };

    template <>
    struct TagOf<ast::program>
    {
        static Tag__ const tag = Tag__::PROGRAM;
    };

    template <>
    struct TagOf<ast::int_list>
    {
        static Tag__ const tag = Tag__::INT_LIST;
    };

    template <>
    struct TagOf<ast::range>
    {
        static Tag__ const tag = Tag__::RANGE;
    };

    template <>
    struct TypeOfBase<Tag__::ID>
    {
        typedef ast::identifier DataType;
    };
    ...
    template <>
    struct TypeOfBase<Tag__::REDUCE>
    {
        typedef ast::reduce_expression DataType;
    };

    template <>
    struct TypeOfBase<Tag__::FOR_ITER>
    {
        typedef ast::for_iteration DataType;
    };

    template <>
    struct TypeOfBase<Tag__::FOR>
    {
        typedef ast::for_expression DataType;
    };

    template <>
    struct TypeOfBase<Tag__::CALL>
    {
        typedef ast::call DataType;
    };

    template <>
    struct TypeOfBase<Tag__::EXPR>
    {
        typedef sp<ast::expression> DataType;
    };

    template <>
    struct TypeOfBase<Tag__::STMT_LIST>
    {
        typedef ast::statement_list DataType;
    };

    template <>
    struct TypeOfBase<Tag__::ID_LIST>
    {
        typedef ast::id_list DataType;
    };

    template <>
    struct TypeOfBase<Tag__::STMT>
    {
        typedef ast::statement DataType;
    };

    template <>
    struct TypeOfBase<Tag__::EXPR_LIST>
    {
        typedef ast::expression_list DataType;
    };

    template <>
    struct TypeOfBase<Tag__::NODE>
    {
        typedef ast::node DataType;
    };

    template <>
    struct TypeOfBase<Tag__::REAL>
    {
        typedef double DataType;
    };

    template <>
    struct TypeOfBase<Tag__::FOR_ITER_LIST>
    {
        typedef ast::for_iteration_list DataType;
    };

    template <>
    struct TypeOfBase<Tag__::EXPR_BLOCK>
    {
        typedef ast::expression_block DataType;
    };

    template <>
    struct TypeOfBase<Tag__::HASH>
    {
        typedef ast::hash_expression DataType;
    };

    template <>
    struct TypeOfBase<Tag__::PROGRAM>
    {
        typedef ast::program DataType;
    };

    template <>
    struct TypeOfBase<Tag__::INT_LIST>
    {
        typedef ast::int_list DataType;
    };

    template <>
    struct TypeOfBase<Tag__::RANGE>
    {
        typedef ast::range DataType;
    };
