...
#if 0
    type_ptr process_binop( const ast::node_ptr & );
    type_ptr process_range( const ast::node_ptr & );
    type_ptr process_extent( const ast::node_ptr & );
    type_ptr process_transpose( const ast::node_ptr & );
    type_ptr process_slice( const ast::node_ptr & );
    type_ptr process_call( const ast::node_ptr & );
    type_ptr process_iteration( const ast::node_ptr & );
    iterator process_iterator( const ast::node_ptr & );
    type_ptr process_reduction( const ast::node_ptr & );
#endif
